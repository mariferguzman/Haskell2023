...
--La logica en si se encuentra en usuariosRelacionValidosAux1
...
-- relacionesAsimetricas. Corrobora que en una lista de relaciones no se encuentra la misma tupla de usuarios pero invertidos. La lógica se encuentra en la función auxiliar.
...
---
--publicacionesValidas. No hay mucha cosa interesante, no hace más que unir 3 funciones explicadas más abajo.
...
-- usuariosLikeValidos. Tengo una lista de usuarios y una lista de los likes. 
...
--noPubliRepAux2. Sirve como auxiliar para comparar la una publi con una lista de publis (es más que nada para meter noPubliRepAux1)
